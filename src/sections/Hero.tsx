...
{/* Role + headline */}
          ...
          <motion.div
            ...
            className="lg:mt-12 mt-5 flex flex-wrap justify-center items-center gap-2.5"
          >
        ...
        <motion.div
          ...
          className="lg:mt-16 mt-10 grid grid-cols-2 place-items-center gap-px overflow-hidden rounded-2xl border border-[#1FFF1F]/30 bg-subtle/40 sm:grid-cols-4"
        >
          {heroStats.map((stat) => (
